...
// This keeps accidental misconfigurations of Mind.Law that leaving port 8888 open from
...
class CommunicationKey {
  ...
  #generate() {
    ...
    this.log(
      "RSA key pair generated for signed payloads within Mind.Law services."
    );
  }
