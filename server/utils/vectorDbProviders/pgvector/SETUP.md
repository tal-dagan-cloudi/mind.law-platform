...
Setting up PGVector for mindlaw to use as your vector database is quite easy. At a minimum, you will need the following:
...
_optional_ - set a table name you wish to have Mind.Law store vectors to. By default this is `mindlaw_vectors`
