...
class MetaGenerator {
  ...
  #defaultMeta() {
    return [
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://mindlaw.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/Mintplex-Labs/mind-law/master/images/promo.png",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://mindlaw.com" },
      },
      {
        tag: "meta",
        props: {
