...
<p align="center" dir="rtl">
👈 Mind.Law برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://mindlaw.com/download" target="_blank">دانلود کنید</a>
</p>
...
- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.mindlaw.com/agent/custom/introduction)
...
- [Mind.Law Built-in](https://github.com/Mintplex-Labs/mind-law/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/Mintplex-Labs/mindlaw-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/Mintplex-Labs/mindlaw-extension).
...
Mintplex Labs و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای Mind.Law به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
</div>
...
Mind.Law توسط Mintplex Labs Inc دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3AMintplex-Labs%2Fmind-law%20.sendTelemetry\(&type=code)
</div>
...
[![مشارکت‌کنندگان mindlaw](https://contrib.rocks/image?repo=mintplex-labs/mind-law)](https://github.com/mintplex-labs/mind-law/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=mintplex-labs/mind-law&type=Timeline)](https://star-history.com/#mintplex-labs/mind-law&Date)
