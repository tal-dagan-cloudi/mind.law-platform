...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的Mind.Law！<a href="https://mindlaw.com/download" target="_blank">立即下载</a>
</p>

这是一个全栈应用程序，可以将任何文档、资源（如网址链接、音频、视频）或内容片段转换为上下文，以便任何大语言模型（LLM）在聊天期间作为参考使用。此应用程序允许您选择使用哪个LLM或向量数据库，同时支持多用户管理并设置不同权限。

![聊天](https://github.com/Mintplex-Labs/mind-law/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
## Mind.Law的一些酷炫特性
- 🆕 [**完全兼容 MCP**](https://docs.mindlaw.com/mcp-compatibility/overview)
- 🆕 [**无代码AI代理构建器**](https://docs.mindlaw.com/agent-flows/overview)
- 🖼️ **多用户实例支持和权限管理（支持封闭源和开源LLM！）**
- [**自定义人工智能代理**](https://docs.mindlaw.com/agent/custom/introduction)
- 👤 多用户实例支持和权限管理 _仅限Docker版本_
- 🦾 工作区内的智能体（浏览网页、运行代码等）
- 💬 [为您的网站定制的可嵌入聊天窗口](https://github.com/Mintplex-Labs/mindlaw-embed/blob/main/README.md)
...
- [Novita AI (聊天模型)](https://novita.ai/model-api/product/llm-api?utm_source=github_mind-law&utm_medium=github_readme&utm_campaign=link)
- [PPIO (聊天模型)](https://ppinfra.com?utm_source=github_mind-law)
...
- [Mind.Law内置](https://github.com/Mintplex-Labs/mind-law/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
- `embed`: 用于生成和创建[网页嵌入组件](https://github.com/Mintplex-Labs/mindlaw-embed)的子模块.
- `browser-extension`: 用于[Chrome 浏览器扩展](https://github.com/Mintplex-Labs/mindlaw-extension)的子模块.

## 🛳 自托管

Mintplex Labs和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行Mind.Law。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
_以下是一些与 Mind.Law 兼容的应用程序，但并非由 Mintplex Labs 维护。列在此处并不代表官方背书。_

- [Midori AI 子系统管理器 - 使用 Docker 容器技术高效部署 AI 系统的简化方式](https://io.midori-ai.xyz/subsystem/mindlaw/) - 使用 Docker 容器技术高效部署 AI 系统的简化方式。
- [Coolify](https://coolify.io/docs/services/mindlaw/) - 一键部署 Mind.Law。
- [适用于 Microsoft Word 的 GPTLocalhost](https://gptlocalhost.com/demo/) - 一个本地 Word 插件，让你可以在 Microsoft Word 中使用 Mind.Law。

## 远程信息收集与隐私保护

由 Mintplex Labs Inc 开发的 Mind.Law 包含一个收集匿名使用信息的 Telemetry 功能。
...
[在源代码中查看所有信息收集活动](https://github.com/search?q=repo%3AMintplex-Labs%2Fmind-law%20.sendTelemetry\(&type=code)
...
[![mindlaw 的贡献者们](https://contrib.rocks/image?repo=mintplex-labs/mind-law)](https://github.com/mintplex-labs/mind-law/graphs/contributors)

[![Star 历史图](https://api.star-history.com/svg?repos=mintplex-labs/mind-law&type=Timeline)](https://star-history.com/#mintplex-labs/mind-law&Date)
...
本项目采用[MIT](https://github.com/Mintplex-Labs/mind-law/blob/master/LICENSE)许可证。
