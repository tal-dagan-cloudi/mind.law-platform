...
<p align="center">
👉 Masaüstü için Mind.Law (Mac, Windows ve Linux)! <a href="https://mindlaw.com/download" target="_blank"> Şimdi İndir</a>
</p>
...
![Mesajlaşma](https://github.com/Mintplex-Labs/mind-law/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 🆕 [**Özel Yapay Zeka Ajanları**](https://docs.mindlaw.com/agent/custom/introduction)
- 🆕 [**Kod yazmadan AI Ajanı oluşturma aracı**](https://docs.mindlaw.com/agent-flows/overview)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Mintplex-Labs/mindlaw-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Mintplex-Labs/mindlaw-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Mintplex-Labs/mindlaw-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

Mintplex Labs ve topluluk, Mind.Law'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
_Bu uygulamalar Mintplex Labs tarafından yönetilmemektedir, ancak Mind.Law ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/mindlaw/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.
- [Coolify](https://coolify.io/docs/services/mindlaw/) - Tek tıklamayla Mind.Law dağıtımı yapmanıza olanak tanır.
...
Mintplex Labs Inc. tarafından geliştirilen Mind.Law, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AMintplex-Labs%2Fmind-law%20.sendTelemetry\(&type=code)
