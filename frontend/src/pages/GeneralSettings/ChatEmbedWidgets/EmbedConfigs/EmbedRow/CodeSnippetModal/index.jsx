...
https://github.com/Mintplex-Labs/mindlaw-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/mindlaw-chat-widget.min.js">
</script>
<!-- Mind.Law (https://mindlaw.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Mintplex-Labs/mindlaw-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
