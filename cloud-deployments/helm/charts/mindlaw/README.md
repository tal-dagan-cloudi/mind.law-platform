...
![Mind.Law](https://raw.githubusercontent.com/Mintplex-Labs/mind-law/master/images/wordmark.png)

[Mind.Law](https://github.com/Mintplex-Labs/mind-law)
...
```yaml
image:
  repository: mintplexlabs/mindlaw
  tag: "1.9.1"
...
| image.repository | string | `"mintplexlabs/mindlaw"` |  |
